...
void txn2(Txn_manager* txn_m)
{
	...
	*/
	string query1 = "select ?x where { <me> <mingzhi> ?x}";
	string update1 = "insert data { <me> <mingzhi> \"zhangzhe\"}";
	string update5 = "insert data { <me> <mingzhi> \"zhangzhe1\"}";
	string update6 = "insert data { <me> <mingzhi> \"zhangzhe2\"}";
	string update7 = "insert data { <me> <mingzhi> \"zhangzhe3\"}";
	string update8 = "insert data { <me> <mingzhi> \"zhangzhe4\"}";
	string update9 = "insert data { <me> <mingzhi> \"zhangzhe5\"}";
	string update10 = "insert data { <me> <mingzhi> \"zhangzhe6\"}";
	string update11 = "insert data { <me> <mingzhi> \"zhangzhe6\"}";
	string update3 = "insert data { <you> <mingzhi> <SBBBBB>}";
	string update4 = "delete data { <you> <mingzhi> <SBBBBB>}";
	string update2 = "delete where {<me> <mingzhi> ?y}";
	string res;
	txn_id_t id = txn_m->Begin();
	int ret;
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	//txn_m->Get_Transaction(id)->print_ReadSet();
	ret = txn_m->Query(id, update1,res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, update5, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, update6, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, update7, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, update8, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, update9, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, update10, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, update11, res);
	print_ans(ret, res);
	ret = txn_m->Query(id, query1, res);
	print_ans(ret, res);
	txn_m->Get_Transaction(id)->print_ReadSet();
	txn_m->Get_Transaction(id)->print_WriteSet();
